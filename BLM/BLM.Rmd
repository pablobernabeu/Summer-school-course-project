...
Preprocessing was performed equally for all sourcesâas standard in topic modeling, by removing non-relevant ('stop-words') and non-linguistic elements. Removed items included the names of the media, as well as numbers, punctuation, links, and technical signs such as @.
...
![&uarr; Sentiment comparison across sources](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/SentientScoreDatasetBoxplot.png){target="_top"}
<br>
...
![<br> [&uarr; LDAvis visualization of NYT articles (click to explore in detail)](http://rristo.github.io/NYT/index.html){target="_top"}](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/Untitled3.png){target="_top"}

<br>

![<br> [&uarr; LDAvis visualization of Facebook comments (click to explore in detail)](http://rristo.github.io/Facebook/index.html#topic=0&lambda=1&term=){target="_top"}](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/Untitled1.png){target="_top"}

<br>

![<br> [&uarr; LDAvis visualization of tweets (click to explore in detail)](http://rristo.github.io/Twitter/index.html#topic=0&lambda=1&term=){target="_top"}](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/Untitled.png){target="_top"}
...
![&uarr; Facebook comments and NYT articles](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/CorporaCompareFbvsNYT.png){target="_top"}

![&uarr; Facebook comments and tweets](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/CorporaCompareFbvsTw.png){target="_top"}

![&uarr; Tweets and NYT articles](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/CorporaCompareTwvsNYT.png){target="_top"}
...
![Similarity between Facebook comments and NYT articles](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/CosineSimFbVsNYT.png){target="_top"}
<br>
&uarr; Similarity between Facebook comments and NYT articles
<br>
<br>

![Similarity between Facebook comments and tweets](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/CosineSimFbVsTw.png){target="_top"}
<br>
&uarr; Similarity between Facebook comments and tweets
<br>
<br>

![Similarity between tweets and NYT articles](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/CosineSimTwvsNYT.png){target="_top"}
<br>
...
![&uarr; Topic fluctuations over time for the three content sources](https://github.com/RRisto/Summer-school-course-project/raw/master/BLM/TopicTime.png){target="_top"}
